<div class="wrap">
    ...
    $url_help        = admin_url( 'edit.php?post_type=product&page=product_wogo&tab=wogo_help' );
    ...
    } else if ( isset( $_GET['tab'] ) && $_GET['tab'] == 'wogo_help' ) {
        $help = 'nav-tab-active';
    } else {
    ...
    <h2 class="nav-tab-wrapper wogo-nav-tab-wrap">
        ...
        <a href="<?php echo $url_help; ?>" class="nav-tab <?php echo isset( $help ) ? $help : ''; ?>"><?php _e( 'Help', 'wogo' ); ?></a>
    ...
    if ( isset( $_GET['post_type'] ) && $_GET['post_type'] == 'product' ) {
        ...
        } else if( isset( $_GET['page'] ) && $_GET['page'] == 'product_wogo' && isset( $_GET['tab']) && $_GET['tab'] == 'wogo_help'  ) {
